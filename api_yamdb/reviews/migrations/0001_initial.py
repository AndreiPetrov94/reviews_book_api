# Generated by Django 3.2 on 2024-11-19 20:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('admin', 'admin'), ('moderator', 'moderator'), ('user', 'user')], default='user', max_length=20)),
                ('confirmation_code', models.CharField(blank=True, default='XXXX', max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.IntegerField(validators=[django.core.validators.MinValueValidator(1, 'Допустимы значения от 1 до 10'), django.core.validators.MaxValueValidator(10, 'Допустимы значения от 1 до 10')])),
